...
fun ChargersView(navController: NavController){
    scafll(navController,"Chargers",Color(0xFF0972CE), "AFC",{ContentChargersView(it)})
}

@Composable
fun ContentChargersView(navController: NavController){
    ...
    Column (
        ...
        R2(R.drawable.chargerss, "Los Ángeles")
